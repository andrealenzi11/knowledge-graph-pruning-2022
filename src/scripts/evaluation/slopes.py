...
out_d = os.path.join(RESULTS_DIR, "slopes", "slopes_ranking_by_dataset.csv")
...
df_dataset.to_csv(out_d, sep=";", encoding="utf-8")
print(df_dataset)
#############################
...
out_t = os.path.join(RESULTS_DIR, "slopes", "slopes_ranking_by_task.csv")
...
df_task.to_csv(out_t, sep=";", encoding="utf-8")
print(df_task)
########################
